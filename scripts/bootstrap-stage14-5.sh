...
echo "======================================"
echo " ADOS STAGE 14.5"
echo " Repository Review Engine"
echo "======================================"

mkdir -p python/ados/reasoning

cat > python/ados/reasoning/review.py <<'PY'
...
grep -q "RepositoryReviewEngine" python/ados/reasoning/__init__.py 2>/dev/null || cat >> python/ados/reasoning/__init__.py <<'PY'
from .review import RepositoryReviewEngine
PY

echo
echo "[1] repository review engine"
echo "[2] exports"
