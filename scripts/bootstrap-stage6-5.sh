...
cat > python/ados/research/comparator.py <<'PY'
...
cat > scripts/compare-repositories.sh <<'SH'
#!/usr/bin/env bash

python3 python/ados/research/comparator.py
SH

chmod +x scripts/compare-repositories.sh
