...
cat > python/ados/intelligence/architecture.py <<'PY'
#!/usr/bin/env python3
...
chmod +x python/ados/intelligence/architecture.py

#######################################################

echo "[2] launcher"

cat > scripts/architecture.sh <<'SH'
#!/usr/bin/env bash

python3 python/ados/intelligence/architecture.py
SH

chmod +x scripts/architecture.sh
