...
echo "======================================"
echo " ADOS STAGE 15.1"
echo " Technical Debt Analyzer"
echo "======================================"

mkdir -p python/ados/reasoning

cat > python/ados/reasoning/technical_debt.py <<'PY'
...
grep -q "TechnicalDebtAnalyzer" python/ados/reasoning/__init__.py 2>/dev/null || cat >> python/ados/reasoning/__init__.py <<'PY'
...
if '"technical_debt_summary"' not in text:
...
echo
echo "[1] technical debt analyzer"
